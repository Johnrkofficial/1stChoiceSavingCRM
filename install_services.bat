...
REM .\bin\mariadb\mariadb10.6.5\bin\mysql_install_db.exe --datadir=C:/1stChoiceSavingCRM/bin/mariadb/data --port=3306 --password=WAMPMYSQLXXX >> doliwamp.log 2>>&1
.\bin\mariadb\mariadb10.6.5\bin\mysql_install_db.exe --datadir=C:/1stChoiceSavingCRM/bin/mariadb/data --port=3306 >> doliwamp.log 2>>&1
